...
export const metadata = {
  title: "About | NES TATTOO",
  description:
    "About NES TATTOO - Professional tattoo artist specializing in custom art and cover-ups.",
};
  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* About Hero */}
        <AnimateOnScroll>
        <section className="pt-44 pb-28 px-12 text-center bg-white animate-on-scroll">
        ...
        <AnimateOnScroll>
        <section className="py-28 px-12 bg-white animate-on-scroll">
        ...
        <AnimateOnScroll>
        <section className="py-28 px-12 bg-black text-white animate-on-scroll">
          <div className="max-w-[1300px] mx-auto">
